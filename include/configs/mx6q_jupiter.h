 ...
 *
 * Configuration settings for the MX6Q Jupiter board.
 *
...
#define	CONFIG_EXTRA_ENV_SETTINGS 	\
	...
	"bootargs_nfs=setenv bootargs ${bootargs} root=/dev/nfs rw "\
	...
	"bootcmd_mmc=run bootargs_base bootargs_mmc; "   			\
		"mmc dev 3; mmc read ${loadaddr} 0x800 0x2000; bootm\0"	\
...
#define CONFIG_SYS_PROMPT		"MX6Q Jupiter U-Boot > "
